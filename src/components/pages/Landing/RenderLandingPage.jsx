...
function RenderLandingPage(props) {
  ...
  return (
    <div className="main">
      ...
      <div className='view-more-and-download-data-btn-container'> {/*added a container for both buttons to use flexbox */}
      ...
      <div>
        ...
        <div className="bottom-section">
          <div className='bottom-section-header-container'>
            <h1>Systemic Disparity Insights</h1>
          </div>
          <div className='bottom-section-stats-container'>
            <div className='stats-one-container'>
              <h3>36%</h3>
              <p>By the end of the Trump administration, the average asylum office grant rate had fallen 36 percent from an average of 44 percent in fiscal year 2016 to 28 percent in fiscal year 2020.</p>
            </div>
            <div className='stats-two-container'>
              <h3>5%</h3>
              <p>The New York asylum office grant rate dropped to 5 percent in fiscal year 2020.</p>
            </div>
            <div className='stats-three-container'>
              <h3>6x Lower</h3>
